...
import { properties, allProperties } from "@/data/demoProporties";
...
export default function SeoProperties({ spaceType }) {
  ...
  const locationProperties = allProperties;
  console.log("Filter Data on Seo Page", spaceType);
  ...
  //   useEffect(() => {
  //     const type = spaceType.get("spaceType") || "";
  //     const location = location.get("location") || "";
  ...
  const clearFilter = () => {
    dispatch({ categorytypetype: "CLEAR_FILTER" });
  };
...
"
                      >
                        <div className="homelengo-box">
                          <div className="archive-top">
                            <Link href={`/${elm.id}`} className="images-group">
                          ...
                          <div className="archive-bottom">
                            <div className="content-top">
                              <h6 className="text-capitalize">
                                <Link href={`/${elm.id}`} className="link">
                                  {elm.title}
                                </Link>
                              </h6>
                ...
                <ul className="justify-content-center wd-navigation mt-20">
                  <Pagination
                    ...
                    itemLength={locationProperties.length}
