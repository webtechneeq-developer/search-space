          ...
          <div className="content-right">
            <div className="box-title wow fadeInUp">
              ...
              <p className="desc text-variant-1 text-variant-01">
                Search Spaces is the fastest-growing flexible workspace marketplace in Mumbai, Navi Mumbai & Pune. We are a coworking office space aggregator for searching and comparing coworking office spaces. 
              </p>

              <p className="desc text-variant-1 text-variant-01">
                We connect corporates and startups with ready-to-move-in, flexible workspaces—without charging brokerage.
              </p>
              <p className="desc text-variant-1 text-variant-01">
                Whether you’re looking for private offices, dedicated desks, flexi desks, meeting rooms, day passes, or virtual offices—we’ve got all covered.
              </p>
              <ul className="about-list">
                <li><p>Over 100 coworking spaces listed across the region</p></li>
                <li><p>More than 500 satisfied customers</p></li>
              </ul>
            </div>
            <div
              className="container flat-service wow fadeInUp"
              data-wow-delay=".2s"
              style={{
                display: "flex",
                flexWrap: "wrap",
            ...
            >
                ...
                <a href="#" className="box-benefit hover-btn-view">
                  ...
                  <div className="content">
                    ...
                    <p className="description">
                      Free Wi-Fi • Housekeeping • Pantry • Tea & Coffee • Parking • Printing • AC & more.
                    </p>
              ...
              <div>
                <a href="#" className="box-benefit hover-btn-view">
                  ...
                  <div className="content">
                    ...
                    <p className="description">
                      Transparent pricing. No hidden costs. Absolutely zero brokerage.
                    </p>
                    {/* <span className="btn-view style-1">
                    <span className="text">Explore Now</span>
                    <span className="icon icon-arrow-right2" />
              ...
              <div>
                <a href="#" className="box-benefit hover-btn-view">
                  ...
                  <div className="content">
                    ...
                    <p className="description">
                      Only trusted and verified coworking spaces listed on our platform.
                    </p>
                    {/* <span className="btn-view style-1">
                    <span className="text">Explore Now</span>
                    <span className="icon icon-arrow-right2" />
              ...
              <div>
                <a href="#" className="box-benefit hover-btn-view">
                  ...
                  <div className="content">
                    <h5 className="title">Quick Turnaround</h5>
                    <p className="description">
                      Streamlined, fast process to ensure you can move in without delay.
                    </p>
                    {/* <span className="btn-view style-1">
                    <span className="text">Explore Now</span>
                    <span className="icon icon-arrow-right2" />
                ...
                <a href="#" className="box-benefit hover-btn-view">
                  ...
                  <div className="content">
                    <h5 className="title">Assistance</h5>
                    <p className="description">
                       Filtered and shortlisted properties for clients.
                    </p>
                    {/* <span className="btn-view style-1">
                    <span className="text">Explore Now</span>
                    <span className="icon icon-arrow-right2" />
