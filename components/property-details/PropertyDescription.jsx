  ...
  return (
    <>
      ...
      <p className="text-variant-1">
        Located around an hour away from {propertyItem.address}, between the
        Perche and the Iton valley, in a beautiful wooded park bordered by a
        charming stream, this country property immediately seduces with its
