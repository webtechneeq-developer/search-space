        ...
        <div className="wrap-banner bg-primary-new flat-title-page1">
          <div className="row">
            <div className="col-lg-4">
              <div className="box-left box-left01">
                <div className="box-title">
                  {/* <div className="text-subtitle text-primary">
                    Wish to be part of our team?
                  </div> */}
                  <h6 className="mt-4 fw-8">
                    <span className="span-title">Zero</span> Brokerage Fees
                  </h6>
                  {/* <h6 className="mt-4 fw-8">
                    <span className="">No</span> Hidden Cost
                  </h6>
            ...
            <div className="col-lg-4">
              <div className="box-left box-left01">
                <div className="box-title">
                  ...
                  <h6 className="mt-4 fw-8">
                    <span className="span-title">No</span> Hidden Cost
                  </h6>
                  {/* <h6 className="mt-4 fw-8">
                    <span className="">100%</span> Verified Listings
                  </h6> */}
            ...
            <div className="col-lg-4">
              <div className="box-left">
                <div className="box-title">
                  ...
                  <h6 className="mt-4 fw-8">
                    <span className="span-title">100%</span> Verified Listings
                  </h6>
                </div>
                <Link
                  href={`/contact`}
